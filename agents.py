    ...
    def variation_analysis_agent(self):
        return Agent(
            ...
            goal="""
                ...
                explique as maiores variações positivas.
                2.1 Determine se a justificativa está alinhada adequadamente com principais variação observadas.
                3. justificativas que mensionam Variação positivas de Material precisam explicar o aumento do consumo de material na ordem.   
